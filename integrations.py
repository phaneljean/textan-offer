...
def send_offer_email(to_email: str, pdf_path: str, parsed: dict, thread_url: str = None) -> dict:
    ...
    payload = {
        ...
        "subject": f"Purchase Offer - {parsed.get('address', 'New Offer')}",
        "content": [{"type": "text/plain", "value": (
            ...
            + (f"View offer details and respond: {thread_url}\n\n" if thread_url else "")
